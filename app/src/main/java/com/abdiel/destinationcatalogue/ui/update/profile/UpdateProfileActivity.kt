...
import com.abdiel.destinationcatalogue.databinding.ActivityUpdateProfileBinding
...
//    private var profilePicture : String? = null
    ...
    override fun onBackPressed() {
        ...
        if (binding.etUsername.textOf().isNotEmpty() && binding.etUsername.textOf() != userName) {
            unsavedAlert()
            return
        }
        finish()
